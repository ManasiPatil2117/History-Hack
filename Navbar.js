document.write(`<nav class="navbar navbar-expand-lg bg-light p-3">
<div class="container-fluid">
  <a class="navbar-brand fw-bold" href="#">History Hack</a>
  <button
    ...
    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a class="dropdown-item" href="Austria.html">Austria</a></li>
          <li><a class="dropdown-item" href="Egypt.html">Egypt</a></li>
          <li><a class="dropdown-item" href="Czech_Republic.html">Czech Republic</a></li>
